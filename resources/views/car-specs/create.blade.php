    ...
    <div class="container-fluid px-4 py-4">
        ...
        <form action="{{ route('car-specs.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card border rounded-3 shadow-sm">
                        <div class="card-body px-4 py-3">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label text-muted" style="font-size: 13px;">Sospensione anteriore
                                        <span class="text-danger">*</span></label>
                                    <input type="text" name="front_suspension" class="form-control" required>
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label text-muted" style="font-size: 13px;">Sospensione posteriore
                                        <span class="text-danger">*</span></label>
                                    <input type="text" name="rear_suspension" class="form-control" required>
                                </div>
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                <a href="{{ route('car-specs.index') }}" class="btn btn-outline-secondary px-4">Annulla</a>
